...
" }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.connectionlist.setItemText(1, _translate("MainWindow", "1"))
        self.connectionlist.setItemText(2, _translate("MainWindow", "2"))
        self.connectionlist.setItemText(3, _translate("MainWindow", "3"))
        self.connectionlist.setItemText(4, _translate("MainWindow", "4"))
        self.connectionlist.setItemText(5, _translate("MainWindow", "5"))
        self.connectionlist.setItemText(6, _translate("MainWindow", "6"))
        self.Rolllabel.setText(_translate("MainWindow", "Roll"))
        self.setconnection.setText(_translate("MainWindow", "GC"))
