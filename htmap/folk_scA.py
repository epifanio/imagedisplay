...
class FolkA(QWidget):
    def __init__(self, qframe):
        self.folkframeA = qframe
        self.mp = 1
        self.fontsize = 6
        self.initUI()

    def initUI(self):
        self.folkgravelgraphicsView = QtWidgets.QGraphicsView(self.folkframeA)
        self.folkgravelgraphicsView.setGeometry(QtCore.QRect(0, 0, 100, 100))
        self.folkgravelgraphicsView.setStyleSheet("background-color: rgba(0,0,0,0%)")

        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.folkgravelgraphicsView.sizePolicy().hasHeightForWidth())

        self.folkgravelgraphicsView.setSizePolicy(sizePolicy)
        self.folkgravelgraphicsView.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.folkgravelgraphicsView.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.folkgravelgraphicsView.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        self.folkgravelgraphicsView.setObjectName("folkgravelgraphicsView")

        font = QFont()
        font.setPointSize(8)

        self.fx, self.fy = self.folkframeA.size().width(), self.folkframeA.size().height()
        self.fx = self.mp * self.fx
        self.fy = self.mp * self.fy
        self.folkgravelgraphicsView.setMinimumSize(QtCore.QSize(self.fx, self.fy))
        self.folkgravelgraphicsView.setMaximumSize(QtCore.QSize(self.fx, self.fy))

        self.drawbuttons(self.mp)


    def createScene(self):
        self.folkframeA.setMinimumSize(QtCore.QSize(self.fx, self.fy))
        self.folkframeA.setMaximumSize(QtCore.QSize(self.fx, self.fy))
        self.folkgravelgraphicsView.setMinimumSize(QtCore.QSize(self.fx, self.fy))
        self.folkgravelgraphicsView.setMaximumSize(QtCore.QSize(self.fx, self.fy))
        ...
        self.folkgravelgraphicsView.setScene(self.scene)
